<?php
/**
 * API: Analyse de soumission sous-traitant par IA
 * Reçoit une image/PDF en base64, retourne les données extraites
 */
...
try {
    ...
    $result = $aiService->analyserSoumission($imageData, $mimeType, $etapes);
