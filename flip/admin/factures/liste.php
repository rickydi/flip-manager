                            ...
                            ?>
                                <tr onclick="window.location='<?= url('/admin/factures/modifier.php?id=' . $facture['id']) ?>'" style="cursor:pointer" class="<?= $isRemboursement ? 'table-success' : '' ?>">
                                    <td class="text-center" onclick="event.stopPropagation()">
                                        <?php if ($isImage): ?>
                                            <a href="/flip/uploads/factures/<?= $facture['fichier'] ?>" target="_blank">
                                                <img src="/flip/uploads/factures/<?= $facture['fichier'] ?>" 
                                                     alt="Facture" 
                                                     style="width:40px;height:40px;object-fit:cover;border-radius:4px;border:1px solid #ddd">
                                            </a>
                                        <?php elseif ($isPdf): ?>
                                            <a href="/flip/uploads/factures/<?= $facture['fichier'] ?>" target="_blank" class="text-danger">
